...
class EmailNotificationService:
    ...
    def _build_email_message(
        ...
        # Ensure From and To are str for mypy type checking
        message["From"] = self.config.email_from or self.config.smtp_user or ""
    ...
    def send_notification(
        ...
        try:
            ...
            with smtplib.SMTP(self.config.smtp_host, self.config.smtp_port) as server:
                server.starttls()
                # Ensure smtp_user and smtp_password are str for mypy type checking
